      ...
      <Html>
        ...
        <BodyWrapper content={content}>
          ...
          <Section className="py-4 text-center">
            <Icon name="check" size={24} alt="Azelyse Piercing" center />
            <Text className="mb-0 mt-2 font-bold">Réservation confirmée</Text>
          </Section>
          <Hr />
          ...
          <Section>
            ...
            <Text>
              Nous vous confirmons votre rendez-vous chez{" "}
...
NewMeeting.PreviewProps = {
  ...
  informations: [
    ...
    "**Mineurs** : Si vous êtes mineur.e et que la prestation de piercing est autorisée, veuillez venir accompagné.e d'un tuteur légal pour signer l'autorisation.",
