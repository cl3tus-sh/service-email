...
import MeetingDate from "./components/MeetingDate.js";
import type {
  AzelysseContent,
  AzelysseMeeting,
...
const CancelMeeting = ({ meeting, content }: Props): ReactElement => {
  ...
  return (
    <Tailwind>
      <Html>
        <Head />
        <Preview>Annulation de rendez-vous.</Preview>
        <BodyWrapper content={content}>
          <Header />
          <Section className="py-4 text-center">
            <Icon name="close" size={24} alt="Azelyse Piercing" center />
            <Text className="mb-0 mt-2 font-bold">Réservation annulée</Text>
          </Section>
          <Hr />
